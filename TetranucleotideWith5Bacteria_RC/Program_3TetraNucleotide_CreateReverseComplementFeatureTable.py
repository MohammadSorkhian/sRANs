...
CombinedDataset_path = "./combinedDataset_nFeatureTable.tsv"
...
while len(featuresName)>0 : 
    ...
    if (tetraNucleotide_ReverseComp == tetraNucleotideName):
        combinedDataset[f'{tetraNucleotideName}/{tetraNucleotide_ReverseComp}'] = combinedDataset[tetraNucleotideName]
    else:
